package com.example.sis248.opencvdemo_new;
...
public class BrightnessManipulationUsingOpenCV extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {

    private static final String TAG = "BrightnessManipulationUsingOpenCV";
